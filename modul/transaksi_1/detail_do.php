...
//		$tambah = mysql_query("insert into trans_tujuan (no_trans,no_do,kode_tujuan) values ('$notrans','$no_do','$coba')");
		...
		$update=mysql_query("update transaksi set multidrop_klien='$multi1', total_klien='$total1', multidrop_vendor='$multi2', total_vendor='$total2', margin='$margin' where no_trans='$[no_trans]'");

		} elseif (isset($_POST['hapus_tujuan'])) {
		$hapus = mysql_query("delete from trans_tujuan where no_do='$no_do'");
		$update=mysql_query("update trans_do set multi='multi' where no_trans='$notrans' and no_do=$no_do");
